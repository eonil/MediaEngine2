...
#pragma mark	-	GLM Version
		...
		bool const
		Quaternion::operator==(const Eonil::Improvisations::MediaEngine::Mathematics::Value::Quaternion &other) const
		{
...
//			}
		...
		Quaternion const
		Quaternion::Utility::quaternionWithAxisAngle(const Eonil::Improvisations::MediaEngine::Mathematics::Value::AxisAngle aa)
		{
...
//			}
		Quaternion const
		Quaternion::Utility::quaternionBySamplingUsingSphericalQuadraticInterpolation(const Eonil::Improvisations::MediaEngine::Mathematics::Value::Quaternion a, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Quaternion b, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Quaternion c, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Quaternion d, const Scalar t)
		{
