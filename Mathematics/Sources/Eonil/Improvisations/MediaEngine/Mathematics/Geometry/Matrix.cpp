...
Vector3 const
Matrix4::transform(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector3 point) const
{
	return	CONV4(transform(Vector4(point,1.0f))).EEVxyz;
}
Vector4 const
Matrix4::transform(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 point) const
{
	return	CONV4(GLKMatrix4MultiplyVector4(CONV16(*this).GLK, CONV4(point).GLKV)).EEV;
}
Vector2 const
Matrix4::transform(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector2 point) const
{
