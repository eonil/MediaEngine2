...
#define	EONIL_MEDIA_ENGINE_MATHEMATICS_NAMESPACE_BEGIN				namespace Eonil { namespace MediaEngine { namespace Mathematics {
#define	EONIL_MEDIA_ENGINE_MATHEMATICS_NAMESPACE_END				} } }

#define	EONIL_MEDIA_ENGINE_MATHEMATICS_DEBUGGING_NAMESPACE_BEGIN	namespace Eonil { namespace MediaEngine { namespace Mathematics { namespace Debugging {
#define	EONIL_MEDIA_ENGINE_MATHEMATICS_DEBUGGING_NAMESPACE_END		} } } }

#define	EONIL_MEDIA_ENGINE_MATHEMATICS_TRIGONOMETRY_NAMESPACE_BEGIN	namespace Eonil { namespace MediaEngine { namespace Mathematics { namespace Trigonometry {
#define	EONIL_MEDIA_ENGINE_MATHEMATICS_TRIGONOMETRY_NAMESPACE_END	} } } }

#define	EONIL_MEDIA_ENGINE_MATHEMATICS_GEOMETRY_NAMESPACE_BEGIN		namespace Eonil { namespace MediaEngine { namespace Mathematics { namespace Geometry {
