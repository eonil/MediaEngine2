...
//			EONIL_MEDIA_ENGINE_DEBUG_ONLY_RUN(_dbg_source_content = data);
		...
		ArrayBuffer::~ArrayBuffer()
		{
			if (_name != NULL_GL_NAME())
			{
				...
				EONIL_MEDIA_ENGINE_DEBUG_ONLY_RUN(_name = 0);
			}
			
			Debug::ObjectInstanceAddressTracker<ArrayBuffer>::unregisterObjectAddress(this);
		}
...
//		}
		...
		ElementArrayBuffer::ElementArrayBuffer(Legacy2013SharedMemory const data)
		{
		...
		ElementArrayBuffer::~ElementArrayBuffer()
		{
			...
			Debug::ObjectInstanceAddressTracker<ElementArrayBuffer>::unregisterObjectAddress(this);
		}
