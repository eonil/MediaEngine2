...
#pragma mark	-	`Model` Implementation
		...
		Model::treeTransformsWithObjectTransformAtTimeInMotion(const Eonil::Improvisations::MediaEngine::Mathematics::Value::Matrix4 objectTransform, const Size timeinMotion, const Size motionIndex) const
		{
