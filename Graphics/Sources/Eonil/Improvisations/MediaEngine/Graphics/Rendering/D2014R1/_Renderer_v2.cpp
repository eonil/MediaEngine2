...
namespace Eonil { namespace Improvisations { namespace MediaEngine { namespace Graphics {
	...
	Rendering
	{
		...
		D2014R1
		{
			...
			void
			_Renderer_v2::renderWithWorldToFrameTransform(const Eonil::Improvisations::MediaEngine::Graphics::Rendering::D2014R1::_Renderer_v2::Scene scene, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Matrix4 worldToFrameTransform)
			{
