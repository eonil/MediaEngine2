...
namespace Eonil { namespace Improvisations { namespace MediaEngine { namespace Graphics {
	...
	Rendering
	{
		...
		D2014R1
		{
			...
			_LineMeshForm const
			_LineMeshForm::lineMeshWithTransform(const Eonil::Improvisations::MediaEngine::Mathematics::Value::Matrix4 m) const
			{
				_LineMeshForm	f1;
				for (Line l : lines())
				{
			...
			void
			_LineMeshForm::setTransform(const Eonil::Improvisations::MediaEngine::Mathematics::Value::Matrix4 m)
			{
				_tm	=	m;
			}
			void
			...
			void
			_LineMeshForm::addLine(const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 from, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 to, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 color)
			{
				Line	l;
			...
			_LineMeshForm const
			_LineMeshForm::Utility::quadraticGrid(const Size halfWidth, const Size halfHeight, const Scalar unitLength, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 centerColor, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 borderColor, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 otherColor)
			{
			...
			_LineMeshForm const
			_LineMeshForm::Utility::cubicCross(const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector3 halfLength, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 xColor, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 yColor, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Vector4 zColor)
			{
	...
	//				"varying vec4		fcolor;				\n"
			...
			void
			_LineMeshForm::_renderOnMachine(Server::Machine &m, Server::_Legacy2013_SharingBox<Server::Program> &p, const std::vector<_LineMeshForm> &fs, const Eonil::Improvisations::MediaEngine::Mathematics::Value::Matrix4 worldToFrameTransform)
			{
