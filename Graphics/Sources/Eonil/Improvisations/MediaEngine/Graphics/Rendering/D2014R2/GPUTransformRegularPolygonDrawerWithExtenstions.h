...
#ifndef __Graphics__GPUTransformRegularPolygonDrawerWithExtenstions__
#define __Graphics__GPUTransformRegularPolygonDrawerWithExtenstions__
...
#endif /* defined(__Graphics__GPUTransformRegularPolygonDrawerWithExtenstions__) */
