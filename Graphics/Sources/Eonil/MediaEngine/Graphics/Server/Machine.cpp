...
//				return	Doctor::stringWithCFormat("<Machine: 0x%llx, vertex channels = \n%s\n>", (uint64_t)(uintptr_t)this, vchsdesc.cString());
		...
		void
		Machine::setViewport(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Bounds2 bounds)
		{
...
#pragma mark	-	Deprecated Methods
		...
		void
		Machine::setScissor(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Bounds2 bounds)
		{
			EEGL_ASSERT(not bounds.isNaN());
			EEGL_ASSERT(bounds != Bounds2::Utility::infinity());
