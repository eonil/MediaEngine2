...
//			 
//			 */
//			[[deprecated]]	auto				draw(void const* const vertexes, VertexLayoutDescriptor const& layout, ProgramVertexChannelingDescriptor2 const& channeling, GenericMemoryRange<PlanarTexture const> const& textures, DrawingMode const& mode, Range const& range) -> void;
//			[[deprecated]]	auto				draw(void const* const vertexes, VertexLayoutDescriptor const& layout, ProgramVertexChannelingDescriptor2 const& channeling, vec<PlanarTexture> const& textures, DrawingMode const& mode, Range const& range) -> void;
//			[[deprecated]]	auto				draw(void const* const vertexes, VertexLayoutDescriptor const& layout, ProgramVertexChannelingDescriptor2 const& channeling, PlanarTexture const& texture, DrawingMode const& mode, Range const& range) -> void;
...
//			
//			[[deprecated]]	auto				draw(Server::ArrayBuffer const& vertexes, VertexLayoutDescriptor const& layout, ProgramVertexChannelingDescriptor2 const& channeling, GenericMemoryRange<PlanarTexture const> const& textures, DrawingMode const& mode, Range const& range) -> void;
////			[[deprecated]]	auto				draw(Server::ArrayBuffer const& vertexes, VertexLayoutDescriptor const& layout, ProgramVertexChannelingDescriptor2 const& channeling, vec<PlanarTexture> const& textures, DrawingMode const& mode, Range const& range) -> void;
////			[[deprecated]]	auto				draw(Server::ArrayBuffer const& vertexes, VertexLayoutDescriptor const& layout, ProgramVertexChannelingDescriptor2 const& channeling, PlanarTexture const& texture, DrawingMode const& mode, Range const& range) -> void;
