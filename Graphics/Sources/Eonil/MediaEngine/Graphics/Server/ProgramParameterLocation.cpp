...
namespace Eonil { namespace Improvisations { namespace MediaEngine { namespace Graphics {
	...
	Server
	{
		...
		void
		ProgramUniformValueSlotProxy::setValue(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector2 &value)
		{
			_validateProgramBinding();
		...
		void
		ProgramUniformValueSlotProxy::setValue(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector3 &value)
		{
			_validateProgramBinding();
		...
		void
		ProgramUniformValueSlotProxy::setValue(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 &value)
		{
			_validateProgramBinding();
		...
		void
		ProgramUniformValueSlotProxy::setValue(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Quaternion &value)
		{
			_validateProgramBinding();
		...
		void
		ProgramUniformValueSlotProxy::setValue(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Matrix4 &value)
		{
			_validateProgramBinding();
		...
		void
		ProgramUniformValueSlotProxy::setValueArray(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Scalar *const values, const Size count)
		{
		...
		void
		ProgramUniformValueSlotProxy::setValueArray(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 *const values, const Size count)
		{
			GLsizei	c	=	toGLsizei(count);
			_validateProgramBinding();
		...
		void
		ProgramUniformValueSlotProxy::setValueArray(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Matrix4 *const values, const Size count)
		{
			GLsizei	c	=	toGLsizei(count);
			_validateProgramBinding();
