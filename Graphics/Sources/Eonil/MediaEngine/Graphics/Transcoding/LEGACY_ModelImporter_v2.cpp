...
#include "LEGACY_PackSerializerA.h"

#include <fstream>
#include <Eonil/Improvisations/MediaEngine/Mathematics/Geometry/InternalRawAlgorithmStuffs/D2014R2/ConversionUnions.h>
	...
	Transcoding
	{
		...
		namespace
		{
			...
			readBoneAndItsSubbones(BonePEB b0)
			{
				...
				FLOAT32x16		conv(b0.defaultTransform().components);
