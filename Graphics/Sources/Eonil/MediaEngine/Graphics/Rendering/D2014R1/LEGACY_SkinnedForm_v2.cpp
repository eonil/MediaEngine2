...
//			
//			void
//			_SkinnedForm_v2::_renderOnMachine(Server::Machine &m, Server::_Legacy2013_SharingBox<Server::Program> &p, const std::vector<_SkinnedForm_v2> &fs, const Matrix4 worldToFrameTransform)
//			{
