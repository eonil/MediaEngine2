...
namespace Eonil { namespace Improvisations { namespace MediaEngine { namespace Graphics {
	...
	//					"	c1.xyz				*=	c1.w;												\n"
			...
			_TriangleListMeshForm_v2::Utility::boxWithColor(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector2 min, const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector2 max, const Eonil::Improvisations::MediaEngine::Graphics::Value::Color color)
			{
			...
			void
			_TriangleListMeshForm_v2::_renderOnMachine(Server::Machine &m, CommonResource &r, const std::vector<_TriangleListMeshForm_v2> &fs, const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Matrix4 worldToFrameTransform)
			{
