...
namespace Eonil { namespace Improvisations { namespace MediaEngine { namespace Graphics {
	...
	Rendering
	{
		...
		D2014R1
		{
			...
			Vector4 const
			_Camera_v1::transformPointInWorldToScope(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 p) const
			{
				return	worldToScopeMatrix().transform(p);
			}
			Vector4 const
			_Camera_v1::transformPointInScopeToFrame(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 p) const
			{
				return	scopeToFrameMatrix().transform(p);
			}
			Vector4 const
			_Camera_v1::transformPointInWorldToFrame(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 p) const
			{
			...
			Vector4 const
			_Camera_v1::transformPointInWorldFromScope(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 p) const
			{
				return	worldFromScopeMatrix().transform(p);
			}
			Vector4 const
			_Camera_v1::transformPointInScopeFromFrame(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 p) const
			{
				return	scopeFromFrameMatrix().transform(p);
			}
			Vector4 const
			_Camera_v1::transformPointInWorldFromFrame(const Eonil::Improvisations::MediaEngine::Mathematics::Geometry::Vector4 p) const
			{
