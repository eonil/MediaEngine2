...
Rendering
{
	...
	D2014R2
	{
		...
		auto DebuggingInformationOverlayDrawer::
		drawBox(DisplayScreenFrame const& frame, const Matrix4 &transform, Vector2 const& halfSize, Vector4 const& color) const -> void
		{
			Vector4		c			{color};
		...
		auto DebuggingInformationOverlayDrawer::
		drawCube(DisplayScreenFrame const& frame, const Matrix4 &transform, Vector3 const& halfSize, Vector4 const& color) const -> void
		{
			Vector4		c			{color};
