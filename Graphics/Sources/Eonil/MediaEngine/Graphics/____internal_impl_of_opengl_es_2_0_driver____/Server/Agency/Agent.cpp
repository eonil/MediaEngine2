...
//			
//			auto
//			draw(Rendering::D2014R2::DisplayScreenFrame const& frame, Program& program, VertexLayoutDescriptor const& format, void const* const vertexes, Texture2D const& texture, DrawingMode const& mode, Range const& range) -> void
//			{
//				Size	num_ch	=
...
////			
////			auto
////			draw(Rendering::D2014R2::DisplayScreenFrame const& frame, Program& program, vec<UniformProgramParameter> const& parameters, VertexLayoutDescriptor const& format, void const* const vertexes, Texture2D const& texture, DrawingMode const& mode, Range const& range) -> void
////			{
////				Size	num_ch	=
////				setAllVertexChannelings(vertexes, format);
////				{
