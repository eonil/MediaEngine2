...
////			
////			auto ProgramVertexChannelingDescriptor::
////			analyze(const Server::Utility::VertexLayoutDescriptor &layout, const Server::Program &program) -> ProgramVertexChannelingDescriptor
////			{
////				vec<Size>	chidxs{};
////				
...
//			
//			auto ProgramVertexChannelingDescriptor2::
//			analyze(const Server::Utility::VertexLayoutDescriptor &layout, Eonil::Improvisations::MediaEngine::Graphics::Server::Program &program) -> ProgramVertexChannelingDescriptor2
//			{
//				vec<SLOT>	ch_slots{};
//				
//				for (Size i=0; i<layout.channelComponents().size(); i++)
