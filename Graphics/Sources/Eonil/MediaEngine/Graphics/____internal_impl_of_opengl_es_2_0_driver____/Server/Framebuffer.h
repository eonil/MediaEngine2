...
#error	EONIL_MEDIA_ENGINE_MISSING_IMPLEMENTATION_FOR_TARGET_PLATFORM
	...
	public:
		 ...
		 */
		Renderbuffer(FORMAT const& format, sz const& width, sz const& height);
	...
	public:
		...
		public:
			...
			ChannelStorage(Texture2D const& texture, TEXTURE_TARGET const& target, GLint const& level = 0);
...
//				auto	setStorage(Texture2D const& texture, TEXTURE_TARGET const& target, GLint const& level = 0) -> void;
