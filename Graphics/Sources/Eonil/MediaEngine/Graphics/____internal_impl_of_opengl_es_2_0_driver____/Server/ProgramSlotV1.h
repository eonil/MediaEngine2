...
//			void					setValue(glm::mat4 const value);
		...
		void	setValueArray(Scalar const* const values, sz const count);
		void	setValueArray(Vector4 const* const values, sz const count);
		void	setValueArray(Matrix4 const* const values, sz const count);
