...
#define	EONIL_MEDIA_ENGINE_GRAPHICS_SERVER2_NAMESPACE_BEGIN					namespace Eonil { namespace Improvisations { namespace MediaEngine { namespace Graphics { namespace Server2 {
#define	EONIL_MEDIA_ENGINE_GRAPHICS_SERVER2_NAMESPACE_END					} } } } }
