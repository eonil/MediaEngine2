...
D2014R1			//	Distribution 2014, revision 1.
{
	...
	/*!
	 ...
	 @warning
	 This is debugging-only object. Do not use this object for release build.
	 */
	class
	TrackableObject
	{
	...
	protected:
		...
		TrackableObject(TrackableObject&& o)
		{
			...
			{
				err9_converted_legacy_assertion(o._dbg_virtual_ownership_list.size() == 0, "`TrackableObject` cannot be moved after it has been referenced. This object already been referenced, and moving will break the references, so moving has been prohibited after being referenced.");
			}
